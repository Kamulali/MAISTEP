...
This repository contains code for stellar characterizing stars, with specific focus on parameters like mass, radius, and age using a stacking-like ML approach 
